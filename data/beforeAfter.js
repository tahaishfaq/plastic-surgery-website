export const caseStudyImages = {
  ...
  breastReductionBefore: "/images/placeholders/before-after/before-01.svg",
  breastReductionAfter: "/images/placeholders/before-after/after-01.svg",
  breastImplantationBefore: "/images/placeholders/before-after/before-02.svg",
  breastImplantationAfter: "/images/placeholders/before-after/after-02.svg",
  rhinoplastyBefore: "/images/placeholders/before-after/before-03.svg",
  rhinoplastyAfter: "/images/placeholders/before-after/after-03.svg",
  gynecomastiaBefore: "/images/placeholders/before-after/before-04.svg",
  gynecomastiaAfter: "/images/placeholders/before-after/after-04.svg",
};
...
export const beforeAfterCategories = [
  ...
  { id: "breast-reduction", label: "Breast Reduction" },
  { id: "breast-implantation", label: "Breast Implantation" },
...
export const beforeAfterGallery = [
  ...
  },
  {
    ...
    title: "Breast reduction contouring",
    description:
      "Surgical reduction to decrease breast volume and improve proportion. Illustrative frames until consented patient photography is approved for publication.",
    provisional: true,
    before: {
      src: caseStudyImages.breastReductionBefore,
      alt: "Illustrative before frame for breast reduction",
      width: 800,
      height: 1000,
    },
    after: {
      src: caseStudyImages.breastReductionAfter,
      alt: "Illustrative after frame for breast reduction",
      width: 800,
      height: 1000,
    },
  },
  {
    id: "bi-01",
    category: "breast-implantation",
    title: "Breast implantation augmentation",
    description:
      "Augmentation planning focused on breast shape, volume, and natural-looking proportion. Illustrative frames until consented patient photography is approved.",
    provisional: true,
    before: {
      src: caseStudyImages.breastImplantationBefore,
      alt: "Illustrative before frame for breast implantation",
      width: 800,
      height: 1000,
    },
    after: {
      src: caseStudyImages.breastImplantationAfter,
      alt: "Illustrative after frame for breast implantation",
      width: 800,
      height: 1000,
    },
  },
  {
    ...
    title: "Rhinoplasty nasal refinement",
    description:
      "Nasal refinement focused on facial balance and natural-looking results. Illustrative frames until consented patient photography is approved for publication.",
    provisional: true,
    before: {
      src: caseStudyImages.rhinoplastyBefore,
      alt: "Illustrative before frame for rhinoplasty",
      width: 800,
      height: 1000,
    },
    after: {
      src: caseStudyImages.rhinoplastyAfter,
      alt: "Illustrative after frame for rhinoplasty",
      width: 800,
      height: 1000,
    },
  },
  {
    ...
    title: "Gynecomastia chest contouring",
    description:
      "Male chest contouring to reduce excess tissue and improve chest definition. Illustrative frames until consented patient photography is approved.",
    provisional: true,
    before: {
      src: caseStudyImages.gynecomastiaBefore,
      alt: "Illustrative before frame for gynecomastia surgery",
      width: 800,
      height: 1000,
    },
    after: {
      src: caseStudyImages.gynecomastiaAfter,
      alt: "Illustrative after frame for gynecomastia surgery",
      width: 800,
      height: 1000,
    },
  },
