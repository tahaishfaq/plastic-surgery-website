...
export const metadata = {
  title: "Our Clinical Team | Rahman Plastic Surgery",
  description:
    "Meet the surgeons and specialists at Rahman Plastic Surgery, led by Dr. Zahid Latif, Medical Director.",
};
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden border border-brand-line bg-brand-white">
                <Image
                  ...
                  className={[
                    "object-cover",
                    !doctorsPageContent.isFinalized ? "scale-105 blur-[4px]" : "",
                  ].join(" ")}
                />
              </div>
              <div>
